package com.bbq.module.infra.websocket;
...
import com.bbq.framework.websocket.core.sender.WebSocketMessageSender;
import com.bbq.framework.websocket.core.util.WebSocketFrameworkUtils;
import com.bbq.module.infra.websocket.message.DemoReceiveMessage;
import com.bbq.module.infra.websocket.message.DemoSendMessage;
...
public class DemoWebSocketMessageListener implements WebSocketMessageListener<DemoSendMessage> {
    ...
    @Autowired(required = false) // 由于 bbq.websocket.enable 配置项，可以关闭 WebSocket 的功能，所以这里只能不强制注入
