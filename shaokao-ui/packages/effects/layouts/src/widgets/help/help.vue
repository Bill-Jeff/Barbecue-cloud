      ...
      <div class="mt-2 flex flex-col">
        <VbenButtonGroup class="basis-1/3" :gap="2" border size="large">
          ...
          <VbenButton
            variant="link"
            @click="
              openWindow('https://gitee.com/bbqcode/bbq-ui-admin-vben')
            "
          >
            Gitee
          </VbenButton>
          <VbenButton
            variant="link"
            @click="
              openWindow('https://github.com/bbqcode/bbq-ui-admin-vben')
            "
          >
            Github
          </VbenButton>
        ...
        <VbenButtonGroup class="basis-1/3" :gap="2" border size="large">
          ...
          <VbenButton
            ...
            @click="
              openWindow(
                'https://gitee.com/bbqcode/bbq-ui-admin-vben/issues',
              )
            "
          >
            Gitee
          ...
          <VbenButton
            ...
            @click="
              openWindow(
                'https://github.com/bbqcode/bbq-ui-admin-vben/issues',
              )
            "
          >
            Github
