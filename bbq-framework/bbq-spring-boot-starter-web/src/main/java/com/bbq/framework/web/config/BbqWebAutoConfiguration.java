package com.bbq.framework.web.config;
...
import com.bbq.framework.web.core.filter.CacheRequestBodyFilter;
import com.bbq.framework.web.core.filter.DemoFilter;
import com.bbq.framework.web.core.handler.GlobalExceptionHandler;
import com.bbq.framework.web.core.handler.GlobalResponseBodyHandler;
...
public class BbqWebAutoConfiguration {
     ...
     */
    @Bean
    @ConditionalOnProperty(value = "bbq.demo", havingValue = "true")
