package com.bbq.framework.jackson.config;

import com.bbq.framework.common.util.json.JsonUtils;
import com.bbq.framework.common.util.json.databind.NumberSerializer;
import com.bbq.framework.common.util.json.databind.TimestampLocalDateTimeDeserializer;
import com.bbq.framework.common.util.json.databind.TimestampLocalDateTimeSerializer;
...
@Slf4j
public class BbqJacksonAutoConfiguration {
