package com.bbq.framework.mybatis.config;

import cn.hutool.core.collection.CollUtil;
import cn.hutool.core.util.StrUtil;
import com.bbq.framework.common.util.json.JsonUtils;
import com.bbq.framework.mybatis.core.handler.DefaultDBFieldHandler;
...
@MapperScan(value = "${bbq.info.base-package}", annotationClass = Mapper.class,
        lazyInitialization = "${mybatis.lazy-initialization:false}") // Mapper 懒加载，目前仅用于单元测试
public class BbqMybatisAutoConfiguration {
