package com.bbq.framework.tracer.config;

import com.bbq.framework.common.enums.WebFilterOrderEnum;
import com.bbq.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "bbq.tracer", value = "enable", matchIfMissing = true)
public class BbqTracerAutoConfiguration {
