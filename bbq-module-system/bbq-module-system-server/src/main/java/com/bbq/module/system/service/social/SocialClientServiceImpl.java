package com.bbq.module.system.service.social;
...
import com.bbq.framework.common.util.cache.CacheUtils;
import com.bbq.framework.common.util.http.HttpUtils;
import com.bbq.framework.common.util.object.BeanUtils;
import com.bbq.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import com.bbq.module.system.api.social.dto.SocialWxaOrderNotifyConfirmReceiveReqDTO;
import com.bbq.module.system.api.social.dto.SocialWxaOrderUploadShippingInfoReqDTO;
import com.bbq.module.system.api.social.dto.SocialWxaSubscribeMessageSendReqDTO;
import com.bbq.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import com.bbq.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import com.bbq.module.system.dal.dataobject.social.SocialClientDO;
import com.bbq.module.system.dal.mysql.social.SocialClientMapper;
import com.bbq.module.system.dal.redis.RedisKeyConstants;
import com.bbq.module.system.enums.social.SocialTypeEnum;
import com.bbq.module.system.framework.justauth.core.AuthRequestFactory;
...
import static com.bbq.framework.common.util.collection.MapUtils.findAndThen;
import static com.bbq.framework.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
import static com.bbq.framework.common.util.date.LocalDateTimeUtils.toEpochSecond;
import static com.bbq.framework.common.util.json.JsonUtils.toJsonString;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${bbq.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${bbq.wxa-subscribe-message.miniprogram-state:formal}")
    ...
    public void uploadWxaOrderShippingInfo(Integer userType, SocialWxaOrderUploadShippingInfoReqDTO reqDTO) {
        ...
        // 对应 ISSUE：https://gitee.com/zhijiantianya/bbq-cloud/pulls/230
