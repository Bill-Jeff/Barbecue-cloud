package com.bbq.module.system.controller.admin.socail.vo.client;

import cn.hutool.core.util.StrUtil;
import com.bbq.framework.common.enums.CommonStatusEnum;
import com.bbq.framework.common.enums.UserTypeEnum;
import com.bbq.framework.common.validation.InEnum;
...
public class SocialClientSaveReqVO {
    ...
    @Schema(description = "应用名", requiredMode = Schema.RequiredMode.REQUIRED, example = "bbq商城")
