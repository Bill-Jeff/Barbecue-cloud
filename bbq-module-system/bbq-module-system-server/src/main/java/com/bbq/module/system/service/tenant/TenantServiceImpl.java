package com.bbq.module.system.service.tenant;
...
import com.bbq.framework.tenant.config.TenantProperties;
import com.bbq.framework.tenant.core.context.TenantContextHolder;
import com.bbq.framework.tenant.core.util.TenantUtils;
import com.bbq.module.system.controller.admin.permission.vo.role.RoleSaveReqVO;
import com.bbq.module.system.controller.admin.tenant.vo.tenant.TenantPageReqVO;
import com.bbq.module.system.controller.admin.tenant.vo.tenant.TenantSaveReqVO;
import com.bbq.module.system.convert.tenant.TenantConvert;
import com.bbq.module.system.dal.dataobject.permission.MenuDO;
import com.bbq.module.system.dal.dataobject.permission.RoleDO;
import com.bbq.module.system.dal.dataobject.tenant.TenantDO;
import com.bbq.module.system.dal.dataobject.tenant.TenantPackageDO;
import com.bbq.module.system.dal.mysql.tenant.TenantMapper;
import com.bbq.module.system.enums.permission.RoleCodeEnum;
import com.bbq.module.system.enums.permission.RoleTypeEnum;
import com.bbq.module.system.service.permission.MenuService;
import com.bbq.module.system.service.permission.PermissionService;
import com.bbq.module.system.service.permission.RoleService;
import com.bbq.module.system.service.tenant.handler.TenantInfoHandler;
import com.bbq.module.system.service.tenant.handler.TenantMenuHandler;
...
public class TenantServiceImpl implements TenantService {
    ...
    @Autowired(required = false) // 由于 bbq.tenant.enable 配置项，可以关闭多租户的功能，所以这里只能不强制注入
