...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.bbq";
    private static final String ARTIFACT_ID = "bbq";
    private static final String PACKAGE_NAME = "com.bbq";
    private static final String TITLE = "烧烤管理系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "com.bbq";
        String artifactIdNew = "bbq";
        String packageNameNew = "com.bbq";
        String titleNew = "烧烤管理系统";
