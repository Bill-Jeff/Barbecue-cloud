package com.bbq.gateway.filter.security;
...
import com.bbq.gateway.util.SecurityFrameworkUtils;
import com.bbq.gateway.util.WebFrameworkUtils;
import com.bbq.framework.common.biz.system.oauth2.OAuth2TokenCommonApi;
import com.bbq.framework.common.biz.system.oauth2.dto.OAuth2AccessTokenCheckRespDTO;
...
public class TokenAuthenticationFilter implements GlobalFilter, Ordered {
     ...
     * key2：访问令牌
     */
    private final LoadingCache<KeyValue<Long, String>, LoginUser> loginUserCache = buildAsyncReloadingCache(Duration.ofMinutes(10),
