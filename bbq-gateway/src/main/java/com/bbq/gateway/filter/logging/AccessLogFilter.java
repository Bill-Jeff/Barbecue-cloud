package com.bbq.gateway.filter.logging;
 ...
 * 网关的访问日志过滤器
 *
 * 从功能上，它类似 bbq-spring-boot-starter-web 的 ApiAccessLogFilter 过滤器
 *
...
public class AccessLogFilter implements GlobalFilter, Ordered {
    ...
    private void writeAccessLog(AccessLog gatewayLog) {
        ...
        try {
            ...
            // 兜底处理，参见 https://gitee.com/zhijiantianya/bbq-cloud/issues/IC9A70
